  ...
  return (
    ...
    >
      <defs>
        ...
        >
          <stop offset='0' stopColor='#6e3f63'></stop>
          <stop offset='0.15' stopColor='#633d62'></stop>
          <stop offset='0.41' stopColor='#473660'></stop>
          <stop offset='0.5' stopColor='#3b335f'></stop>
          <stop offset='0.6' stopColor='#38315c' stopOpacity='0.88'></stop>
          <stop offset='0.76' stopColor='#302b55' stopOpacity='0.57'></stop>
          <stop offset='0.97' stopColor='#242249' stopOpacity='0.07'></stop>
          <stop offset='1' stopColor='#222147' stopOpacity='0'></stop>
        </radialGradient>
      </defs>
      <g data-name='Capa 1'>
        <path fill='url(#a)' d='M645.06 0v372.73H4.2L0 0h645.06z'></path>
        <path
          fill='#d29b72'
          d='M487.31 222.05a2.41 2.41 0 014.81 0c0 1.33-1.08 49.27-2.41 49.27s-2.4-47.94-2.4-49.27z'
        ></path>
        <circle cx='489.71' cy='222.05' r='1.69' fill='#e8c275'></circle>
        <path
          fill='#f3eece'
        ...
        ></path>
        <path fill='#e8c275' d='M339.19 252.5a1 1 0 111 1 1 1 0 01-1-1z'></path>
        <circle cx='340.16' cy='252.5' r='0.62' fill='#f3eece'></circle>
        <g opacity='0.5'>
          <path
            fill='#d29b72'
          ...
          ></path>
          <circle cx='371.96' cy='172.82' r='0.81' fill='#f3eece'></circle>
        </g>
        <path
          fill='#f3eece'
          d='M466.22 225.08a1.29 1.29 0 11-1.28-1.28 1.28 1.28 0 011.28 1.28zm-116-39.08a1.29 1.29 0 01-2.57 0 1.29 1.29 0 112.57 0z'
        ></path>
        <circle cx='497.5' cy='176.37' r='1.29' fill='#f3eece'></circle>
        <path
          fill='#f3eece'
          d='M370.17 248.47a1.29 1.29 0 11-1.29-1.29 1.28 1.28 0 011.29 1.29z'
        ></path>
        <circle cx='277.03' cy='215.66' r='1.29' fill='#f3eece'></circle>
        <path
          fill='#fff'
          d='M330.41 224.8a.65.65 0 11-.64-.64.65.65 0 01.64.64zm139.41 2.54a.65.65 0 11-.65-.64.65.65 0 01.65.64z'
        ></path>
        <circle cx='260.82' cy='273.25' r='1.29' fill='#f3eece'></circle>
        <path
          fill='#fff'
          d='M265.7 275.52a.65.65 0 11-.64-.65.64.64 0 01.64.65zm266.63-8.88a.65.65 0 11-.65-.65.65.65 0 01.65.65z'
        ></path>
        <circle cx='528.92' cy='271.89' r='1.29' fill='#f3eece'></circle>
        <path
          fill='#fff'
        ...
        ></path>
        <circle cx='333.34' cy='222.07' r='1.29' fill='#f3eece'></circle>
        <circle
          cx='338.06'
          cy='135.84'
          r='13.93'
        ...
        <path
          fill='#dbb07b'
          d='M330.81 139.82a1.71 1.71 0 112.35-.55 1.7 1.7 0 01-2.35.55zm2.83-6.58a3 3 0 114.09-1 3 3 0 01-4.09 1z'
          opacity='0.3'
        ></path>
        <path
          fill='#dbb07b'
          d='M333.42 131.79a1.6 1.6 0 112.2-.52 1.6 1.6 0 01-2.2.52zm-3.61 2.79a1.47 1.47 0 112-.47 1.46 1.46 0 01-2 .47z'
          opacity='0.3'
        ></path>
        <path
          fill='#dbb07b'
        ...
        <path
          fill='#d3e8f7'
          d='M475 145.87c-.5-.57-1.33-1.42-2-2.07a7.25 7.25 0 00-1.08.81c1.15 1 2.25 2 2.56 2.33s1.52-.04.52-1.07zm8 7.41c-1.45-.85-4.14-2.44-5.28-3.18-1.61-1-2.84-.78-3.32-1.19s-2.24-2.21-3.34-3.24a7.15 7.15 0 00-.44.68c.88 1 2.3 2.53 2.61 2.84.46.47.28 1.16-.27.67-.34-.31-1.82-1.46-2.88-2.29a7.42 7.42 0 00-.33 1.5c1.59 1.43 3.54 2.77 4.14 2.83s1.4-1.22 2.22-.77c.61.34 4.09 2.54 5.8 3.61a6.78 6.78 0 001.09-1.46zm-4.52 3.44a7.2 7.2 0 002.4-1.09c-1.38-.75-3.57-1.91-4.2-2.12-.93-.33-.83 1.31-1.58 1.35s-2.88-1.47-5.2-3.43v.07a7.1 7.1 0 008.58 5.22zm-.39-13.87c.06.38.32.78 1 1.36 1.1.9 2 1.48 2.37 1.87s-.65.54-.12 1.18a14.76 14.76 0 002.49 1.79c0-.3-.09-.6-.16-.9a7.09 7.09 0 00-5.58-5.3zm-.09 4.09c-.46-.67.26-1.39-.28-2.17a23.91 23.91 0 00-1.74-2 6.67 6.67 0 00-1.64.4 23.8 23.8 0 012.12 2.59c.28.54-.58 1.42-.17 1.73s5.54 3.63 7.24 4.73a7.16 7.16 0 00.37-1.6c-1.51-.81-5.57-3.14-5.9-3.68z'
          opacity='0.5'
        ></path>
        <path
          fill='#5f71ae'
        ...
        <path
          fill='#d3e8f7'
          d='M302.86 183.85c-.51-.56-1.33-1.41-2-2.07a7.22 7.22 0 00-1.07.82c1.15 1.05 2.24 2 2.55 2.33s1.44-.04.52-1.08zm7.95 7.42c-1.44-.85-4.13-2.44-5.28-3.18-1.61-1-2.83-.78-3.32-1.19s-2.24-2.21-3.34-3.24a6 6 0 00-.43.68c.88 1 2.29 2.53 2.6 2.84.46.47.28 1.16-.27.67-.34-.31-1.81-1.46-2.87-2.29a6.27 6.27 0 00-.33 1.5c1.58 1.43 3.54 2.76 4.13 2.82s1.41-1.21 2.22-.76c.61.34 4.1 2.54 5.81 3.61a7 7 0 001.08-1.46zm-4.51 3.43a7.07 7.07 0 002.4-1.08c-1.39-.75-3.58-1.91-4.2-2.13-.93-.32-.84 1.31-1.58 1.36s-2.89-1.47-5.21-3.43a.64.64 0 000 .07 7.09 7.09 0 008.59 5.21zm-.4-13.86c.06.38.33.78 1 1.35 1.1.91 2 1.49 2.37 1.88s-.65.54-.11 1.18a14.65 14.65 0 002.48 1.78 5.87 5.87 0 00-.16-.9 7.08 7.08 0 00-5.58-5.29zm-.14 4.09c-.46-.67.27-1.4-.27-2.17a25.6 25.6 0 00-1.74-2l-.81.15a7.46 7.46 0 00-.84.26 24.47 24.47 0 012.13 2.59c.28.54-.59 1.41-.17 1.73s5.54 3.63 7.23 4.73a6.75 6.75 0 00.38-1.61c-1.46-.81-5.53-3.14-5.91-3.68z'
          opacity='0.5'
        ></path>
        <path
          fill='#5f71ae'
        ...
        <path
          ...
          strokeMiterlimit='10'
          strokeWidth='0.735'
          d='M534.73 238.5l6.29-3.83m-20.82-6.77l14.53 10.6 6.18 7.56 7.03-1.19m-19.95-37.73l11.3 13.18 1.73 14.35 5.86 3.5 1.06 6.7 16.49 5.09 15.32.32'
        ></path>
        <path
          fill='#f3eece'
          d='M526.71 207.14a1.28 1.28 0 111.28 1.28 1.27 1.27 0 01-1.28-1.28z'
        ></path>
        <circle cx='539.29' cy='220.32' r='1.41' fill='#f3eece'></circle>
        <path
          fill='#f3eece'
          d='M519.34 227.9a.87.87 0 11.86.86.86.86 0 01-.86-.86zm14.25 10.6a1.14 1.14 0 111.14 1.14 1.14 1.14 0 01-1.14-1.14zm6.57-3.83a.86.86 0 11.86.86.85.85 0 01-.86-.86zM563.57 250a.86.86 0 11.86.86.86.86 0 01-.86-.86z'
        ></path>
        <circle cx='546.88' cy='238.17' r='0.65' fill='#f3eece'></circle>
        <path
          fill='#f3eece'
          d='M540.26 246.06a.65.65 0 111.3 0 .65.65 0 11-1.3 0zm6.74-1.19a1 1 0 111 1 1 1 0 01-1-1z'
        ></path>
        <circle cx='579.75' cy='250.28' r='1.08' fill='#f3eece'></circle>
        <ellipse
          cx='418.58'
          cy='322.91'
          fill='#504382'
        ...
        <path
          fill='#5a477d'
          d='M485.83 307.88v-1.45a25.89 25.89 0 00-8.83-18.77c2.82 2.9 9.1 13.84 2.28 22.17-4.49 5.49-25.78 13.31-43.3 3.26a18 18 0 005.51 4.67c10.13 5.86 26.59 5.86 36.75 0 4.76-2.76 7.29-6.29 7.59-9.88z'
        ></path>
        <path
          fill='#a1727c'
        ...
        <path
          fill='#cca084'
          d='M469.36 308c.95 2.15-.87 5-4.06 6.44s-6.55.79-7.49-1.37.87-5 4.06-6.44 6.54-.8 7.49 1.37zm-12.25 8.76a2.78 2.78 0 11-3.39-.94 2.51 2.51 0 013.39.94z'
          opacity='0.5'
          style={{ mixBlendMode: "lighten" }}
        ></path>
        <path
        ...
        <path
          fill='#a1727c'
          d='M507.52 306.57c.94 2.16-.88 5-4.07 6.45s-6.56.79-7.5-1.37.87-5 4.06-6.45 6.56-.79 7.51 1.37zm-12.27 8.78a2.78 2.78 0 11-3.39-.94 2.53 2.53 0 013.39.94z'
          opacity='0.5'
          style={{ mixBlendMode: "lighten" }}
        ></path>
        <path
        ...
        <path
          fill='#f3eece'
          d='M436.28 294.19H438a5.86 5.86 0 01.93 4c-.21 2-1.61 4.61-2.64 4.61s-2.43-2.61-2.63-4.61a5.89 5.89 0 01.92-4h1.71m-2.99 8.36a.56.56 0 11.56.56.56.56 0 01-.56-.56zm1.7 2.39a1.24 1.24 0 112.48 0 1.24 1.24 0 01-2.48 0z'
        ></path>
        <path
          fill='#b9787a'
        ...
        <path
          fill='#675763'
          d='M442.9 286.93l.16.58-.16-.58zm-12.79 0l-.24.87-.34 1.26.58-2.13z'
        ></path>
        <path
          fill='#604242'
        ...
        <path
          fill='#e7bd88'
          d='M432.27 284h-1.36l-.8 3-.58 2.14-.95 3.47a3.94 3.94 0 002.32 3.23 9.13 9.13 0 002 .84 11.51 11.51 0 001.69.36.41.41 0 00.51-.36.62.62 0 00-.49-.53c-3.15-.83-4.69-2.72-4.52-3.45s1.77-7.11 2.18-8.7zm3.85 12.68c0-.24.29-.44.62-.45s.6.17.61.41-.26.46-.61.46-.62-.19-.62-.42z'
        ...
        <path
          fill='#f3eece'
          d='M401 294.19h1.71a5.86 5.86 0 01.93 4c-.21 2-1.61 4.61-2.64 4.61s-2.43-2.61-2.63-4.61a5.86 5.86 0 01.93-4h1.7m-3 8.36a.56.56 0 11.56.56.56.56 0 01-.56-.56zm1.77 2.39a1.24 1.24 0 012.48 0 1.24 1.24 0 11-2.48 0z'
        ></path>
        <path
          fill='#b9787a'
        ...
        <path
          fill='#675763'
          d='M407.63 286.93l.16.58-.16-.58zm-12.79 0l-.24.87-.34 1.26.58-2.13z'
        ></path>
        <path
          fill='#604242'
        ...
        <path
          fill='#e7bd88'
          d='M397.52 282l-1-1.21-1.69 6.11-.58 2.14-.95 3.47a3.94 3.94 0 002.32 3.23 9.13 9.13 0 002 .84 11.37 11.37 0 001.7.36.41.41 0 00.5-.36.62.62 0 00-.49-.53c-3.15-.83-4.69-2.72-4.52-3.45s2.3-8.94 2.71-10.6zm3.34 14.68c0-.24.28-.44.61-.45a.53.53 0 01.61.41c0 .24-.26.46-.61.46s-.62-.19-.61-.42z'
          style={{ mixBlendMode: "soft-light" }}
        ></path>
        <path
          fill='#675763'
        ...
        <path
          fill='#f3eece'
          d='M418.58 300.62h2.28a7.77 7.77 0 011.23 5.29c-.27 2.67-2.14 6.15-3.51 6.15s-3.24-3.48-3.52-6.15a7.81 7.81 0 011.24-5.29h2.28m-3.98 11.15a.75.75 0 11.75.75.76.76 0 01-.75-.75zm2.32 3.23a1.66 1.66 0 111.66 1.65 1.66 1.66 0 01-1.66-1.65z'
        ></path>
        <path
          fill='#b9787a'
        ...
        <path
          fill='#675763'
          d='M427.4 290.23l.21.78-.21-.78zm-17.06 0l-.32 1.17-.46 1.68.78-2.85z'
        ></path>
        <path
          fill='#604242'
        ...
        <path
          fill='#e7bd88'
          d='M413.22 286.28h-1.81l-1.07 4-.77 2.85-1.26 4.63c0 1.56 1 3.12 3.09 4.31a12 12 0 002.69 1.12 15.37 15.37 0 002.26.48.55.55 0 00.68-.48.85.85 0 00-.67-.71c-4.19-1.1-6.24-3.63-6-4.6s2.32-9.43 2.86-11.6zm5.14 16.95a.8.8 0 01.82-.6.72.72 0 01.82.55c0 .32-.35.61-.82.62s-.83-.26-.82-.57z'
          style={{ mixBlendMode: "soft-light" }}
        ></path>
        <path
          fill='#675763'
        ...
        <path
          fill='#e9c488'
          d='M425.22 158.85a6.35 6.35 0 00-6.35 6.35v39.1a6.35 6.35 0 006.35 6.36 6.35 6.35 0 006.35-6.36v-39.1a6.35 6.35 0 00-6.35-6.35zm0 58.94a6.35 6.35 0 00-6.35 6.35v.24a6.35 6.35 0 006.35 6.35 6.35 6.35 0 006.35-6.35v-.24a6.35 6.35 0 00-6.35-6.35z'
        ></path>
        <path
          fill='#ce8a74'
        ...
        <path
          fill='#4b3d6e'
          d='M553.63 329.2v-.72a12.87 12.87 0 00-4.38-9.33c1.4 1.44 4.52 6.87 1.13 11-2.23 2.72-12.81 6.61-21.52 1.61a8.83 8.83 0 002.74 2.33c5 2.91 13.22 2.91 18.26 0 2.36-1.35 3.62-3.09 3.77-4.89z'
        ></path>
        <path
          fill='#7e587b'
          d='M540.59 318.83c.58 1.32-.53 3.08-2.48 3.93s-4 .48-4.57-.83.53-3.08 2.48-3.93 3.98-.48 4.57.83zm-7.47 5.36a1.7 1.7 0 11-2.07-.58 1.54 1.54 0 012.07.58z'
          opacity='0.5'
          style={{ mixBlendMode: "lighten" }}
        ></path>
        <path
        ...
        <path
          fill='#5a477d'
          d='M502.19 345.72v-1.23a21.94 21.94 0 00-7.48-15.94c2.39 2.47 7.72 11.75 1.93 18.83-3.81 4.66-21.89 11.31-36.78 2.77a15.41 15.41 0 004.68 4c8.61 5 22.59 5 31.22 0 4.03-2.38 6.24-5.37 6.43-8.43z'
        ></path>
        <path
          fill='#926279'
          d='M479.92 328c1 2.25-.91 5.26-4.24 6.72s-6.83.82-7.81-1.43.91-5.25 4.23-6.72 6.83-.81 7.82 1.43zm-12.78 9.16a2.9 2.9 0 11-3.53-1 2.63 2.63 0 013.53 1z'
          opacity='0.5'
          style={{ mixBlendMode: "lighten" }}
        ></path>
        <path
        ...
        <path
          fill='#7e587b'
          d='M556.68 325.67c.35.8-.33 1.86-1.5 2.38s-2.42.29-2.77-.51.33-1.85 1.5-2.37 2.42-.29 2.77.5zm-4.52 3.24a1 1 0 01-1.84.81 1 1 0 011.84-.81z'
          opacity='0.5'
          style={{ mixBlendMode: "lighten" }}
        ></path>
        <path
        ...
        <path
          fill='#4b3d6e'
          d='M291.27 324.92v-.72a12.87 12.87 0 014.38-9.33c-1.4 1.44-4.52 6.88-1.13 11 2.23 2.72 12.81 6.61 21.52 1.62a9 9 0 01-2.74 2.32c-5 2.91-13.22 2.91-18.26 0-2.36-1.35-3.62-3.1-3.77-4.89z'
        ></path>
        <path
          fill='#7e587b'
          d='M304.31 314.55c-.58 1.32.53 3.08 2.48 3.93s4 .49 4.57-.83-.53-3.08-2.48-3.93-4-.48-4.57.83zm7.47 5.36a1.7 1.7 0 102.07-.57 1.54 1.54 0 00-2.07.57z'
          opacity='0.5'
          style={{ mixBlendMode: "lighten" }}
        ></path>
        <path
        ...
        <path
          fill='#7e587b'
          d='M299.48 292.27c-.34.76.3 1.78 1.43 2.27s2.31.28 2.64-.48-.31-1.78-1.43-2.27-2.31-.28-2.64.48zm4.32 3.1a.87.87 0 00.56 1.1.89.89 0 001.19-.33 1 1 0 00-1.75-.77z'
          opacity='0.5'
          style={{ mixBlendMode: "lighten" }}
        ></path>
        <path
        ...
        <path
          fill='#5a477d'
          d='M320.73 317.72v-1.32a23.56 23.56 0 018-17.09c-2.57 2.64-8.29 12.6-2.07 20.19 4.08 5 23.47 12.11 39.42 3a16.48 16.48 0 01-5 4.26c-9.23 5.33-24.22 5.33-33.47 0-4.3-2.55-6.61-5.76-6.88-9.04z'
        ></path>
        <path
          fill='#a1727c'
          d='M344.61 298.73c-1.05 2.41 1 5.63 4.55 7.2s7.32.88 8.37-1.53-1-5.63-4.54-7.2-7.32-.88-8.38 1.53zm13.7 9.81a3.11 3.11 0 103.79-1.05 2.81 2.81 0 00-3.79 1.05z'
          opacity='0.5'
          style={{ mixBlendMode: "lighten" }}
        ></path>
        <path
        ...
        <path
          fill='#4f4176'
          d='M313.38 334.83v-.99a17.72 17.72 0 016-12.85c-1.93 2-6.23 9.47-1.56 15.18 3.07 3.75 17.64 9.1 29.63 2.22a12.21 12.21 0 01-3.77 3.2c-6.93 4-18.2 4-25.15 0-3.21-1.89-4.95-4.3-5.15-6.76z'
        ></path>
        <path
          fill='#7e587b'
          d='M331.33 320.56c-.79 1.81.74 4.23 3.42 5.41s5.5.66 6.29-1.15-.73-4.24-3.41-5.41-5.5-.67-6.3 1.15zm10.3 7.37a2.34 2.34 0 102.85-.79 2.12 2.12 0 00-2.85.79z'
          opacity='0.5'
          style={{ mixBlendMode: "lighten" }}
        ></path>
        <path
        ...
        <path
          fill='#5a477d'
          d='M347.73 336.17v-1.23a21.94 21.94 0 017.48-15.94c-2.39 2.47-7.72 11.76-1.93 18.84 3.81 4.65 21.9 11.3 36.78 2.76a15.41 15.41 0 01-4.68 4c-8.61 5-22.59 5-31.22 0-4.03-2.38-6.16-5.38-6.43-8.43z'
        ></path>
        <path
          fill='#cca084'
          d='M370 318.45c-1 2.25.91 5.26 4.24 6.72s6.83.82 7.81-1.43-.9-5.25-4.23-6.71-6.82-.83-7.82 1.42zm12.78 9.16a2.9 2.9 0 103.53-1 2.63 2.63 0 00-3.53 1z'
          opacity='0.5'
          style={{ mixBlendMode: "lighten" }}
        ></path>
        <path
        ...
        <path
          fill='#cca084'
          d='M441.75 330.74c.9 2.06-.83 4.8-3.87 6.14s-6.23.75-7.14-1.3.84-4.8 3.87-6.14 6.23-.75 7.14 1.3zm-11.67 8.36a2.65 2.65 0 11-3.22-.89 2.39 2.39 0 013.22.89z'
          opacity='0.5'
          style={{ mixBlendMode: "lighten" }}
        ></path>
        <path
        ...
        <path
          fill='#cca084'
          d='M397.33 333.67c-.86 1.95.79 4.56 3.68 5.83s5.93.72 6.79-1.24-.79-4.56-3.68-5.83-5.93-.71-6.79 1.24zm11.1 7.95a2.51 2.51 0 103.06-.85 2.27 2.27 0 00-3.06.85z'
          opacity='0.5'
          style={{ mixBlendMode: "lighten" }}
        ></path>
        <path
        ...
        <path
          fill='#9b6779'
          d='M419.8 348.85c.35.79-.32 1.86-1.5 2.37s-2.41.3-2.76-.5.32-1.86 1.5-2.37 2.41-.3 2.76.5zm-4.52 3.24a1 1 0 11-1.25-.35.92.92 0 011.25.35z'
          opacity='0.5'
          style={{ mixBlendMode: "lighten" }}
        ></path>
        <path
        ...
        <path
          fill='#7e587b'
          d='M288.22 321.4c-.34.79.33 1.85 1.5 2.37s2.42.29 2.77-.5-.33-1.86-1.5-2.38-2.42-.29-2.77.51zm4.52 3.23a1 1 0 001.84.81 1 1 0 00-1.84-.81z'
          opacity='0.5'
          style={{ mixBlendMode: "lighten" }}
        ></path>
        <path
        ...
        <path
          fill='#7e587b'
          d='M309.58 296.92c-.21.46.18 1.07.86 1.37s1.4.17 1.6-.29-.19-1.08-.87-1.37-1.39-.17-1.59.29zm2.61 1.87a.52.52 0 00.34.66.48.48 0 10.38-.86.53.53 0 00-.72.2z'
          opacity='0.5'
          style={{ mixBlendMode: "lighten" }}
        ></path>
        <path
        ...
        <path
          fill='#7e587b'
          d='M501.68 289.59c-.2.46.19 1.07.87 1.37s1.39.17 1.6-.29-.19-1.08-.87-1.38-1.39-.16-1.6.3zm2.62 1.87a.52.52 0 00.34.66.48.48 0 10.38-.86.53.53 0 00-.72.2z'
          opacity='0.5'
          style={{ mixBlendMode: "lighten" }}
        ></path>
        <path
