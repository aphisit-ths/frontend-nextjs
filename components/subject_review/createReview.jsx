...
export default function CreateReview({ subjects }) {
  const { course_id, thai_name, eng_name } = subjects[0];
  return (
    <div>
      <div className=" flex flex-col bg-gray-800   items-center p-6 ">
        ...
        <div className=" w-full lg:w-3/6  max-h-full rounded-xl flex flex-col  p-6 px-2  shadow-lg my-10 space-y-3 ">
        <h1 className="font-display self-start font-semibold text-xl text-gray-50">
          เขียนรีวิววิชานี้ <span className="text-red-600">*</span>
        </h1>
        </div>
      </div>
    </div>
