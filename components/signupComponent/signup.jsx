    ...
    <div className={signupStyle.root}>
      <div className={signupStyle.warper}>
        <div className={signupStyle.imgwarp}>
          <Image
            src="https://ouch-cdn2.icons8.com/755sAlfXcDfSpIrHxiGq5aoalxx4F_h4twSGiQUyBRQ/rs:fit:784:1346/czM6Ly9pY29uczgu/b3VjaC1wcm9kLmFz/c2V0cy9wbmcvMC9i/MWQ0YjNhYS1jZGQ5/LTRlNDItODBhYy02/YTAzNDE3NGUxNTIu/cG5n.png"
            alt=""
            width={1300}
            height={2300}
          />
